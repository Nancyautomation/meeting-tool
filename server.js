        ...
        const response = await fetch("https://api.groq.com/openai/v1/chat/completions", {
          ...
          body: JSON.stringify({
            ...
            messages: [
              {
                role: "user",
                content: `Extract all action items from this meeting transcript. Return ONLY a JSON array, no other text or markdown. Each item must have: task (string), owner (string or "Unassigned"), deadline (string or "Not specified"), priority ("high", "medium", or "low"). Infer priority from urgency cues in the text.\n\nTranscript:\n${transcript}`,
              },
            ],
          }),
        });
